                    ...
                    <div id="sidebar" class="inner-span-column-2 omega">
                        ...
                        <div id="chat" class="widget">
                            ...
                            <ul class="list outline">
                                ...
                                <li><a href="#" title="" class="icon-state-chat busy">Thomas Jefferson</a></li>
        ...
        <div id="chatbox-area">
            <div class="chatbox-holder">
                ...
                <div class="chatbox open">
                    <header>
                        <h4 class="name"><a href="#" title="">Thomas Jefferson</a></h4>
                    ...
                    <div class="content">
                        <div class="inner-chat-content">
                                ...
                                <div id="chat-1-message-2" class="chat-message">
                                    <div class="avatar-placeholder"><img src="medias/peoples/02.jpg" alt=""></div>
                                    <div class="message-placeholder">
                                        <p>Oui et toi ?</p>
                                    </div>
                                </div>
                                <div id="chat-1-message-3" class="chat-message">
                                    <div class="avatar-placeholder"><img src="medias/peoples/03.jpg" alt=""></div>
                                    <div class="message-placeholder">
                                        <p>Super merci :) T'a vu le dernier test du prof ?</p>
                                    </div>
                                </div>
                                <div id="chat-1-message-4" class="chat-message">
                                    <div class="avatar-placeholder"><img src="medias/peoples/02.jpg" alt=""></div>
                                    <div class="message-placeholder">
                                        <p>Ouais horrible :s</p>
                                    </div>
                                </div>
                                <div id="chat-1-message-5" class="chat-message">
                                    <div class="avatar-placeholder"><img src="medias/peoples/03.jpg" alt=""></div>
                                    <div class="message-placeholder">
                                        <p>J'ai tout raté ! Je me sens vraiment nulle des fois...</p>
                                    </div>
                                </div>
                                <div id="chat-1-message-6" class="chat-message">
                                    <div class="avatar-placeholder"><img src="medias/peoples/02.jpg" alt=""></div>
                                    <div class="message-placeholder">
                                        <p>Oui tu as raison, tu es nulle. Je vais faire caca.</p>
                                    </div>
                                </div>
                        </div>
                ...
                <div class="chatbox close">
                    <header>
                        <h4 class="name"><a href="#" title="">Nicolas Lescop</a></h4>
                        <div class="action-area">
                            <a href="#" class="icon loop small">Connected</a>
                            <a href="#" class="icon cross small">Close chat</a>
                        </div>
